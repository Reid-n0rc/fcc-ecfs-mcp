...
server.registerTool("ecfs_search_filings", {
    title: "Search ECFS filings",
    description: "Search filings submitted to the FCC's Electronic Comment Filing System (ECFS). " +
...
server.registerTool("ecfs_get_filing", {
...
server.registerTool("ecfs_search_proceedings", {
    title: "Search ECFS proceedings",
    description: "Search proceedings (dockets) registered in the FCC ECFS system, e.g. by docket number.",
...
server.registerTool("ecfs_raw_request", {
    title: "Raw ECFS API request",
    description: "Escape hatch for calling any ECFS public API path/query parameters not covered by the " +
